...
func main() {
	remoteAPIURL := "https://en.walkera.com/index.php?id=download-center" // URL to fetch HTML content from
	localFilePath := "walkera.html"                                       // Path where HTML file will be stored
